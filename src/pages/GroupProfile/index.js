        ...
        <div className='container'>
            ...
            <div className='content'>
                ...
                <div className='group-profile'>
                    <h1>{name}</h1>
                    <p>Sorteio dia: {moment(drawdate).format("DD/MM/YYYY")}</p>
                    <p>Valor minimo: {Intl.NumberFormat('pt-BR',{style:'currency',currency: 'BRL'}).format(minValue)}</p>
                    <p>Valor Maximo: {Intl.NumberFormat('pt-BR',{style:'currency',currency: 'BRL'}).format(maxValue)}</p>
                </div>
